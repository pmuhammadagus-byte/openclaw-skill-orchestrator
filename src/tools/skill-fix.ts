...
import type { FixAction } from "../utils/types.js";
...
export async function applyFix(options: FixOptions): Promise<FixResult> {
...
async function applyPriorityFix(fix: FixAction): Promise<FixResult> {
...
export async function backupSkill(filepath: string): Promise<string> {
